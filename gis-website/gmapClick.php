...
<body>
    ...
    <div class="centered">
        <p>A map with custom icons which are Clickable, when clicked display information about each castle.
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=tee-hee-code-is-gone&callback=initMapClick">
    </script>
</body>
